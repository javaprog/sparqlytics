...
public class Slice extends Dice {
     ...
     */
    public Slice(String dimension, String level, Expr value) {
        super(dimension, level);
        if (value == null) {
            throw new NullPointerException();
        }
        Var variable = filterVarAlloc.allocVar();
        filter = new Filter(variable, new E_Equals(new ExprVar(variable), value));
    }
}
