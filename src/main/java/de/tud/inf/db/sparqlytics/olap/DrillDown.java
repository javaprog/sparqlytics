...
public class DrillDown implements Operation {
     ...
     * @throws IllegalArgumentException of the argument {@code steps} is
     *                                  less than one
     */
    public DrillDown(final String name, final int steps) {
        if (name == null) {
    ...
    public void run(final Session session) {
        Dimension dimension = session.getCube().findDimension(name);
